...
### **Overview**
This phase assumes that you have completed Phase 1 of the assignment (Getting Started with Laravel video series). Completion of Phase 1 is required before beginning Phase 2.
...
2. **Controller**
   - Create a `LikesController` with two methods:
...
2. **Blade Template Example (your finished code may or may not exactly be this code. You may need to modify a bit)**
